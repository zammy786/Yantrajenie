...
public final class bookingStatusGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.yantragenie.status.Status.Request,
      com.yantragenie.status.Status.Response> getShowStatusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ShowStatus",
      requestType = com.yantragenie.status.Status.Request.class,
      responseType = com.yantragenie.status.Status.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yantragenie.status.Status.Request,
      com.yantragenie.status.Status.Response> getShowStatusMethod() {
    io.grpc.MethodDescriptor<com.yantragenie.status.Status.Request, com.yantragenie.status.Status.Response> getShowStatusMethod;
      ...
      synchronized (bookingStatusGrpc.class) {
        if ((getShowStatusMethod = bookingStatusGrpc.getShowStatusMethod) == null) {
          bookingStatusGrpc.getShowStatusMethod = getShowStatusMethod = 
              io.grpc.MethodDescriptor.<com.yantragenie.status.Status.Request, com.yantragenie.status.Status.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "bookingStatus", "ShowStatus"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yantragenie.status.Status.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yantragenie.status.Status.Response.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.yantragenie.status.Status.UpdateRequest,
      com.yantragenie.status.Status.Response> getUpdateTicketStatusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UpdateTicketStatus",
      requestType = com.yantragenie.status.Status.UpdateRequest.class,
      responseType = com.yantragenie.status.Status.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yantragenie.status.Status.UpdateRequest,
      com.yantragenie.status.Status.Response> getUpdateTicketStatusMethod() {
    io.grpc.MethodDescriptor<com.yantragenie.status.Status.UpdateRequest, com.yantragenie.status.Status.Response> getUpdateTicketStatusMethod;
      ...
      synchronized (bookingStatusGrpc.class) {
        if ((getUpdateTicketStatusMethod = bookingStatusGrpc.getUpdateTicketStatusMethod) == null) {
          bookingStatusGrpc.getUpdateTicketStatusMethod = getUpdateTicketStatusMethod = 
              io.grpc.MethodDescriptor.<com.yantragenie.status.Status.UpdateRequest, com.yantragenie.status.Status.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "bookingStatus", "UpdateTicketStatus"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yantragenie.status.Status.UpdateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yantragenie.status.Status.Response.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.yantragenie.status.Status.UpdateRequest,
      com.yantragenie.status.Status.Response> getUpdateBookingStatusMethod;
  ...
  public static io.grpc.MethodDescriptor<com.yantragenie.status.Status.UpdateRequest,
      com.yantragenie.status.Status.Response> getUpdateBookingStatusMethod() {
    io.grpc.MethodDescriptor<com.yantragenie.status.Status.UpdateRequest, com.yantragenie.status.Status.Response> getUpdateBookingStatusMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.yantragenie.status.Status.Request,
      com.yantragenie.status.Status.Response> getInsertNewBookingMethod;
  ...
  public static io.grpc.MethodDescriptor<com.yantragenie.status.Status.Request,
      com.yantragenie.status.Status.Response> getInsertNewBookingMethod() {
    io.grpc.MethodDescriptor<com.yantragenie.status.Status.Request, com.yantragenie.status.Status.Response> getInsertNewBookingMethod;
  ...
  public static abstract class bookingStatusImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void showStatus(com.yantragenie.status.Status.Request request,
        io.grpc.stub.StreamObserver<com.yantragenie.status.Status.Response> responseObserver) {
      asyncUnimplementedUnaryCall(getShowStatusMethod(), responseObserver);
    }

    /**
     */
    public void updateTicketStatus(com.yantragenie.status.Status.UpdateRequest request,
        io.grpc.stub.StreamObserver<com.yantragenie.status.Status.Response> responseObserver) {
    ...
    /**
     */
    public void updateBookingStatus(com.yantragenie.status.Status.UpdateRequest request,
        io.grpc.stub.StreamObserver<com.yantragenie.status.Status.Response> responseObserver) {
    ...
    /**
     */
    public void insertNewBooking(com.yantragenie.status.Status.Request request,
        io.grpc.stub.StreamObserver<com.yantragenie.status.Status.Response> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.yantragenie.status.Status.Request,
                com.yantragenie.status.Status.Response>(
                  this, METHODID_SHOW_STATUS)))
          .addMethod(
            getUpdateTicketStatusMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.yantragenie.status.Status.UpdateRequest,
                com.yantragenie.status.Status.Response>(
  ...
  public static final class bookingStatusBlockingStub extends io.grpc.stub.AbstractStub<bookingStatusBlockingStub> {
    ...
    /**
     */
    public com.yantragenie.status.Status.Response showStatus(com.yantragenie.status.Status.Request request) {
    ...
    /**
     */
    public com.yantragenie.status.Status.Response updateTicketStatus(com.yantragenie.status.Status.UpdateRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public com.yantragenie.status.Status.Response updateBookingStatus(com.yantragenie.status.Status.UpdateRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public com.yantragenie.status.Status.Response insertNewBooking(com.yantragenie.status.Status.Request request) {
      return blockingUnaryCall(
  ...
  public static final class bookingStatusFutureStub extends io.grpc.stub.AbstractStub<bookingStatusFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yantragenie.status.Status.Response> showStatus(
        com.yantragenie.status.Status.Request request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yantragenie.status.Status.Response> updateTicketStatus(
        com.yantragenie.status.Status.UpdateRequest request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yantragenie.status.Status.Response> updateBookingStatus(
        com.yantragenie.status.Status.UpdateRequest request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yantragenie.status.Status.Response> insertNewBooking(
        com.yantragenie.status.Status.Request request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SHOW_STATUS:
          serviceImpl.showStatus((com.yantragenie.status.Status.Request) request,
              (io.grpc.stub.StreamObserver<com.yantragenie.status.Status.Response>) responseObserver);
          break;
        case METHODID_UPDATE_TICKET_STATUS:
          serviceImpl.updateTicketStatus((com.yantragenie.status.Status.UpdateRequest) request,
              (io.grpc.stub.StreamObserver<com.yantragenie.status.Status.Response>) responseObserver);
          break;
        case METHODID_UPDATE_BOOKING_STATUS:
          serviceImpl.updateBookingStatus((com.yantragenie.status.Status.UpdateRequest) request,
              (io.grpc.stub.StreamObserver<com.yantragenie.status.Status.Response>) responseObserver);
          break;
        case METHODID_INSERT_NEW_BOOKING:
          serviceImpl.insertNewBooking((com.yantragenie.status.Status.Request) request,
              (io.grpc.stub.StreamObserver<com.yantragenie.status.Status.Response>) responseObserver);
          break;
        default:
  ...
  private static abstract class bookingStatusBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.yantragenie.status.Status.getDescriptor();
    }
