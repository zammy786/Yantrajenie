...
public final class email1Grpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.yantragenie.email.Email.requestEmailId,
      com.yantragenie.email.Email.emailResponse> getSendEmailMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendEmail",
      requestType = com.yantragenie.email.Email.requestEmailId.class,
      responseType = com.yantragenie.email.Email.emailResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yantragenie.email.Email.requestEmailId,
      com.yantragenie.email.Email.emailResponse> getSendEmailMethod() {
    io.grpc.MethodDescriptor<com.yantragenie.email.Email.requestEmailId, com.yantragenie.email.Email.emailResponse> getSendEmailMethod;
      ...
      synchronized (email1Grpc.class) {
        if ((getSendEmailMethod = email1Grpc.getSendEmailMethod) == null) {
          email1Grpc.getSendEmailMethod = getSendEmailMethod = 
              io.grpc.MethodDescriptor.<com.yantragenie.email.Email.requestEmailId, com.yantragenie.email.Email.emailResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "email1", "sendEmail"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yantragenie.email.Email.requestEmailId.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yantragenie.email.Email.emailResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.yantragenie.email.Email.sendOTP,
      com.yantragenie.email.Email.emailResponse> getSendingOTPMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendingOTP",
      requestType = com.yantragenie.email.Email.sendOTP.class,
      responseType = com.yantragenie.email.Email.emailResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yantragenie.email.Email.sendOTP,
      com.yantragenie.email.Email.emailResponse> getSendingOTPMethod() {
    io.grpc.MethodDescriptor<com.yantragenie.email.Email.sendOTP, com.yantragenie.email.Email.emailResponse> getSendingOTPMethod;
    if ((getSendingOTPMethod = email1Grpc.getSendingOTPMethod) == null) {
      synchronized (email1Grpc.class) {
        if ((getSendingOTPMethod = email1Grpc.getSendingOTPMethod) == null) {
          email1Grpc.getSendingOTPMethod = getSendingOTPMethod = 
              io.grpc.MethodDescriptor.<com.yantragenie.email.Email.sendOTP, com.yantragenie.email.Email.emailResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "email1", "sendingOTP"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yantragenie.email.Email.sendOTP.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yantragenie.email.Email.emailResponse.getDefaultInstance()))
  ...
  public static abstract class email1ImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sendEmail(com.yantragenie.email.Email.requestEmailId request,
        io.grpc.stub.StreamObserver<com.yantragenie.email.Email.emailResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getSendEmailMethod(), responseObserver);
    }

    /**
     */
    public void sendingOTP(com.yantragenie.email.Email.sendOTP request,
        io.grpc.stub.StreamObserver<com.yantragenie.email.Email.emailResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.yantragenie.email.Email.requestEmailId,
                com.yantragenie.email.Email.emailResponse>(
                  this, METHODID_SEND_EMAIL)))
          .addMethod(
            getSendingOTPMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.yantragenie.email.Email.sendOTP,
                com.yantragenie.email.Email.emailResponse>(
  ...
  public static final class email1BlockingStub extends io.grpc.stub.AbstractStub<email1BlockingStub> {
     ...
     * </pre>
     */
    public com.yantragenie.email.Email.emailResponse sendEmail(com.yantragenie.email.Email.requestEmailId request) {
    ...
    /**
     */
    public com.yantragenie.email.Email.emailResponse sendingOTP(com.yantragenie.email.Email.sendOTP request) {
      return blockingUnaryCall(
  ...
  public static final class email1FutureStub extends io.grpc.stub.AbstractStub<email1FutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yantragenie.email.Email.emailResponse> sendEmail(
        com.yantragenie.email.Email.requestEmailId request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yantragenie.email.Email.emailResponse> sendingOTP(
        com.yantragenie.email.Email.sendOTP request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_EMAIL:
          serviceImpl.sendEmail((com.yantragenie.email.Email.requestEmailId) request,
              (io.grpc.stub.StreamObserver<com.yantragenie.email.Email.emailResponse>) responseObserver);
          break;
        case METHODID_SENDING_OTP:
          serviceImpl.sendingOTP((com.yantragenie.email.Email.sendOTP) request,
              (io.grpc.stub.StreamObserver<com.yantragenie.email.Email.emailResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class email1BaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.yantragenie.email.Email.getDescriptor();
    }
